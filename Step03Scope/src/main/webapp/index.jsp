...
<body>
	<div class="container">
		...
		<ul>
			...
			<li><a href="${pageContext.request.contextPath}/test/play.jsp">놀러가기(로그인되 클라이언트만 가능)</a></li>
		</ul>
		<form action="${pageContext.request.contextPath}/test/save.jsp" method="post">
			<input type="text" name="nick" placeholder="닉네임을 입력..." />
